...
///
/// Port 0 is permitted: the operating system interprets it as
...
public value class Port implements RefinedInt {
    ...
    /// True if `value` is a well-known / system port (0–1023).
    public boolean isWellKnown() {
        return value <= 1023;
    }

    /// True if `value` is an ephemeral port per IANA (49152–65535).
